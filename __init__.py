...
yolo_model = load_model("model_data/yolov2.h5") #加载已经训练好了的模型
yolo_model.summary() #加载训练的YOLO模型的权重
yolo_outputs = yolo_head(yolo_model.output, anchors, len(class_names)) #将模型的输出转换为边界框
